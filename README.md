...
- Configurable issue list columns — `columns` in `config.json` orders and selects from: priority, id, state, title, labels, assignee, updated, cycle, due, estimate, milestone
